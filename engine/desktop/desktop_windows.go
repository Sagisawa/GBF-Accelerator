...
// openAppWindow launches Microsoft Edge or Google Chrome in standalone App mode (--app=<url>).
...
// findAppBrowserWindows searches standard install locations, system registry, and PATH for Edge or Chrome.
